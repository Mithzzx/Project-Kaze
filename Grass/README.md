...
![Project Screenshot](Documentation/screenshot.png)
*(Place a screenshot of your project in the Documentation folder and name it screenshot.png)*
...
*   [ ] **Interactive Grass**: Implement physics interactions so grass bends when the player or objects move through it.
*   [ ] **Occlusion Culling**: Use the depth buffer (Hi-Z buffer) to cull grass blades hidden behind other objects (like hills or buildings).

## 📚 References & Acknowledgements

I utilized various online resources to learn the techniques implemented in this project. Special thanks to the following educational content:

*   **GDC**: [Procedural Grass in 'Ghost of Tsushima'](https://www.youtube.com/watch?v=Ibe1JBF5i5Y)
*   **Freya Holmer**: [A coder's guide to spline-based procedural geometry](https://www.youtube.com/watch?v=jvPPXbo87ds)
*   **Wikipedia**: [Phong Shading](https://en.wikipedia.org/wiki/Phong_shading)
*   **Catlike Coding**: [Compute Shaders](https://catlikecoding.com/unity/tutorials/basics/compute-shaders/)
*   **Ned Makes Games**: [Intro to Compute Shaders](https://www.youtube.com/watch?v=BrZ4pWwkpto)
*   **Ronja Tutorials**: [Graphics.DrawProcedural](https://www.ronja-tutorials.com/post/044-draw-procedural/)
*   **Acerola**: [How Do Games Render So Much Grass?](https://www.youtube.com/watch?v=Y0Ko0nE74YE)
